...
export default function PressRelease() {
    ...
    const sendComment = async () => {
        ...
        setIsLoading(true)
        let commentResponse = await GET(`${baseUrl}/PressRelease`,
        ...
        <div className="features-area pt-130 pb-100">
            <Container maxW={'7xl'}>
                <Stack
                    paddingTop={20}
                >
                    <SectionHeading width={'full'} smallHeading={'Press Release'} mainHeading={'Check the Press Release'} marginPosition={'0 auto 0 0'} textAlignment={'center'} />
