...
class CasesArea extends Component {
  ...
  render() {
    ...
    return appState.Causes ? (
      <div className="case-area black-bg pos-rel pt-130 pb-205">
        <div className="shape d-none d-xl-block">
          <div className="shape-item case-01 bounce-animate">
            <img src="assets/img/shape/shape-1.png" alt="" />
          </div>
          <div className="shape-item case-02">
            <img src="assets/img/shape/shape-2.png" alt="" />
          </div>
          <div className="shape-item case-03">
            <img src="assets/img/shape/shape-4.png" alt="" />
          </div>
          <div className="shape-item case-04 bounce-animate">
        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-8 col-lg-8 offset-lg-2 offset-xl-2">
              <div className="section-title white-title text-center mr-40 ml-40 mb-75">
                <span>
                  <i className="far fa-heart-circle" /> our popular causes
                </span>
          ...
          <div
            className="row services-active arrow-style"
            ref={this.casesslider}
          >
            {appState.Causes.listCauses &&
            appState.Causes.listCauses.length > 0 ? (
              appState.Causes.listCauses.map((item, i) => (
                <div className="col-xl-12">
                  <div className="case-wrapper white-bg">
                    <div className="case-text">
                      <h3>
                        <a href="causes-details.html">{item.displaytext}</a>
                      </h3>
